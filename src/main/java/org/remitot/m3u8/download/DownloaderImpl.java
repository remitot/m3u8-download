...
public class DownloaderImpl implements Downloader {
  ...
  public DownloaderImpl(File outFolder, String filenamePrefix, Function<URL, URLConnection> connector) {
  ...
  public DownloaderImpl(File outFolder, String filenamePrefix) {
